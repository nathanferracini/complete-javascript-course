...
import { API_URL, SEARCH_API, RES_PER_PAGE, KEY } from './config.js';
import { getJSON, postJSON as postJSON } from './helpers.js';
...
export const loadSearchResults = async function (query) {
  try {
    ...
    const data = await getJSON(`${SEARCH_API}${query}&key=${KEY}`);
